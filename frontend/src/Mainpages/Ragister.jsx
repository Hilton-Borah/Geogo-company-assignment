      ...
      <button onClick={handleChange}>Add</button> */}
          ...
          {/* <form action="" onSubmit={handleClick}> */}
              ...
              <div class="mt-4 flex items-center justify-center gap-x-6 mb-10">
                <button onClick={handleClick} className="p-2 pl-10 pr-10 bg-blue rounded-md text-white hover:bg-white hover:text-blue border-2 border-blue font-semibold">
                {
          ...
          {/* {
            pin ? <div>
              <PinInput />
              <p className='mt-3 mb-3 border-b-2 border-blue cursor-pointer w-24 text-center m-auto'>Resend OTP</p>
              <div className="flex items-center justify-center mt-3 mb-3">
                <div className="animate-spin rounded-full h-8 w-8 border-t-4 border-blue"></div>
              </div>
              <button className="p-2 pl-10 pr-10 bg-blue rounded-md text-white hover:bg-white hover:text-blue border-2 border-blue font-semibold">Verify OTP</button><br />
            </div> : null
          } */}
        </div>
      </div>
